...
from changeSegmentation.entity.config_entity import DataValidationConfig
from changeSegmentation.entity.artifacts_entity import (DataIngestionArtifact, DataValidationArtifact)
